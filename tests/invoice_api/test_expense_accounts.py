...
from holded.invoice_api.models.expense_accounts import ExpenseAccountCreate, ExpenseAccountUpdate, ExpenseAccountListParams
...
class TestExpenseAccountsResource:
    ...
    def test_list_expense_accounts_with_params(self, client):
        ...
        params = ExpenseAccountListParams(
            page=1,
            limit=10
        )
    ...
    def test_update_expense_account(self, client):
        ...
        if isinstance(created, dict) and "id" in created:
            ...
            # Update the account
            update_data = ExpenseAccountUpdate(
...
class TestAsyncExpenseAccountsResource:
    ...
    async def test_create_expense_account(self, async_client):
        ...
        account_data = ExpenseAccountCreate(
            name="Test Async Expense Account",
    ...
    async def test_update_expense_account(self, async_client):
        ...
        account_data = ExpenseAccountCreate(
            name="Test Async Update Account",
        ...
        if isinstance(created, dict) and "id" in created:
            ...
            # Update the account
            update_data = ExpenseAccountUpdate(
                name="Updated Async Test Account",
    ...
    async def test_delete_expense_account(self, async_client):
        ...
        account_data = ExpenseAccountCreate(
            name="Test Async Delete Account",
            desc="Async account to be deleted",
            accountNum=unique_num
        )
