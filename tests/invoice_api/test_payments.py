...
from holded.invoice_api.models.payments import PaymentCreate, PaymentUpdate, PaymentListParams
...
class TestPaymentsResource:
    ...
    def test_list_payments_with_params(self, client):
        ...
        params = PaymentListParams(
            starttmp=start_timestamp,
            endtmp=end_timestamp
        )
        ...
        try:
            ...
            if isinstance(created, dict) and "id" in created:
                ...
                update_data = PaymentUpdate(
                    desc="Updated payment description",
                    amount=175.00
                )
    ...
    async def test_update_payment(self, async_client):
        ...
        try:
            ...
            if isinstance(created, dict) and "id" in created:
                ...
                update_data = PaymentUpdate(
                    desc="Updated async payment description",
                    amount=275.00
                )
