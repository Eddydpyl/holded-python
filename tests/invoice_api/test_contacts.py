...
from holded.api.invoice.models.contacts import ContactCreate, ContactListParams, ContactUpdate
...
class TestContactsResource:
    ...
    def test_list_contacts_with_params(self, client):
        ...
        params = ContactListParams(page=1, limit=10, phone="+1234567890")
    ...
    def test_list_contacts_with_custom_id(self, client):
        ...
        params = ContactListParams(customId=["CUSTOM001", "CUSTOM002"])
    ...
    def test_create_contact(self, client):
        ...
        contact_data = ContactCreate(name="Test Contact", email="test@example.com", phone="+1234567890", type="client")
    ...
    def test_create_contact_with_dict(self, client):
        ...
        contact_data = {"name": "Test Contact Dict", "email": "testdict@example.com", "type": "supplier"}
    ...
    def test_update_contact(self, client):
        ...
        contact_data = ContactCreate(name="Test Contact Update", email="update@example.com", type="client")
        ...
        if isinstance(created, dict) and "id" in created:
            ...
            # Update the contact
            update_data = ContactUpdate(name="Updated Test Contact", notes="This contact was updated via API test")
    ...
    def test_delete_contact(self, client):
        ...
        # First, create a contact
        contact_data = ContactCreate(name="Test Contact Delete", email="delete@example.com", type="client")
...
class TestAsyncContactsResource:
    ...
    async def test_create_contact(self, async_client):
        ...
        contact_data = ContactCreate(name="Test Async Contact", email="async@example.com", type="client")
    ...
    async def test_update_contact(self, async_client):
        ...
        # Create a contact
        contact_data = ContactCreate(name="Test Async Update", email="asyncupdate@example.com", type="client")
        ...
        if isinstance(created, dict) and "id" in created:
            ...
            # Update the contact
            update_data = ContactUpdate(notes="Updated via async test")
    ...
    async def test_delete_contact(self, async_client):
        ...
        # Create a contact
        contact_data = ContactCreate(name="Test Async Delete", email="asyncdelete@example.com", type="client")
