...
from holded.api.invoice.models.sales_channels import SalesChannelCreate, SalesChannelListParams, SalesChannelUpdate
...
class TestSalesChannelsResource:
    ...
    def test_list_sales_channels_with_params(self, client):
        ...
        params = SalesChannelListParams(page=1, limit=10)
    ...
    def test_create_sales_channel(self, client):
        ...
        channel_data = SalesChannelCreate(name="Test Sales Channel", desc="Test description", accountNum=unique_num)
    ...
    def test_get_sales_channel(self, client):
        ...
        if items and len(items) > 0:
            ...
            channel_data = SalesChannelCreate(
                name="Test Get Channel", desc="Test description for get", accountNum=unique_num
            )
    ...
    def test_update_sales_channel(self, client):
        ...
        channel_data = SalesChannelCreate(
            name="Test Update Channel", desc="Original description", accountNum=unique_num
        )
        ...
        if isinstance(created, dict) and "id" in created:
            ...
            # Update the channel
            update_data = SalesChannelUpdate(name="Updated Test Channel", desc="Updated description")
    ...
    def test_delete_sales_channel(self, client):
        ...
        channel_data = SalesChannelCreate(
            name="Test Delete Channel", desc="Channel to be deleted", accountNum=unique_num
        )
...
class TestAsyncSalesChannelsResource:
    ...
    async def test_create_sales_channel(self, async_client):
        ...
        channel_data = SalesChannelCreate(
            name="Test Async Sales Channel", desc="Test async description", accountNum=unique_num
        )
    ...
    async def test_get_sales_channel(self, async_client):
        ...
        if items and len(items) > 0:
            ...
            channel_data = SalesChannelCreate(
                name="Test Async Get Channel", desc="Test async description for get", accountNum=unique_num
            )
    ...
    async def test_update_sales_channel(self, async_client):
        ...
        channel_data = SalesChannelCreate(
            name="Test Async Update Channel", desc="Original async description", accountNum=unique_num
        )
        ...
        if isinstance(created, dict) and "id" in created:
            ...
            # Update the channel
            update_data = SalesChannelUpdate(name="Updated Async Test Channel", desc="Updated async description")
    ...
    async def test_delete_sales_channel(self, async_client):
        ...
        channel_data = SalesChannelCreate(
            name="Test Async Delete Channel", desc="Async channel to be deleted", accountNum=unique_num
        )
