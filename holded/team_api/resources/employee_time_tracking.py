...
class EmployeeTimeTrackingResource(BaseResource):
    ...
    def list_all(self, page: Optional[int] = None) -> List[Dict[str, Any]]:
        ...
        if page is not None:
            params["page"] = page
        return cast(List[Dict[str, Any]], self.client.get(f"{self.base_path}/times", params=params))
    ...
    def list(self, employee_id: str) -> List[Dict[str, Any]]:
        ...
        Returns:
            A list of time tracking entries
        """
        return cast(List[Dict[str, Any]], self.client.get(f"{self.base_path}/{employee_id}/times"))
    ...
    def create(self, employee_id: str, data: EmployeeTimeTrackingCreate) -> Dict[str, Any]:
        ...
        """
        return cast(Dict[str, Any], self.client.post(f"{self.base_path}/{employee_id}/times", data=data))
    ...
    def get(self, time_tracking_id: str) -> Dict[str, Any]:
        ...
        """
        return cast(Dict[str, Any], self.client.get(f"{self.base_path}/times/{time_tracking_id}"))
    ...
    def update(self, time_tracking_id: str, data: EmployeeTimeTrackingUpdate) -> Dict[str, Any]:
        ...
        """
        return cast(Dict[str, Any], self.client.put(f"{self.base_path}/times/{time_tracking_id}", data=data))
    ...
    def delete(self, time_tracking_id: str) -> Dict[str, Any]:
        ...
        """
        return cast(Dict[str, Any], self.client.delete(f"{self.base_path}/times/{time_tracking_id}"))
    ...
    def clock_out(self, employee_id: str) -> Dict[str, Any]:
        ...
        """
        return cast(Dict[str, Any], self.client.post(f"{self.base_path}/{employee_id}/clock-out"))
