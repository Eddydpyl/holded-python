...
class AsyncContactsResource(AsyncBaseResource):
    ...
    async def list(
        self, 
        params: Optional[Union[Dict[str, Any], ContactListParams]] = None
    ...
    async def create(
        self, 
        data: Union[Dict[str, Any], ContactCreate]
    ...
    async def update(
        self, 
        contact_id: str, 
        data: Union[Dict[str, Any], ContactUpdate]
    ) -> Union[Dict[str, Any], ContactResponse]:
    ...
    async def get_attachments(
        self, 
        contact_id: str
    ) -> Union[List[Dict[str, Any]], ContactAttachmentListResponse]:
