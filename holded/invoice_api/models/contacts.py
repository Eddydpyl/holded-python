...
class ContactListParams(PaginationParams):
    ...
    phone: Optional[str] = Field(default=None, description="Filter by phone number (exact match, including special characters like '+', '#', and '-')")
    mobile: Optional[str] = Field(default=None, description="Filter by mobile number (exact match, including special characters like '+', '#', and '-')")
    customId: Optional[List[str]] = Field(default=None, description="Return only the contacts that match with the provided customId")
