...
from ...base_models import BaseModel, BaseResponse, PaginationParams, DateRangeParams
...
class DocumentListParams(BaseModel):
    ...
    contactid: Optional[str] = Field(default=None, description="Filtering by contact Id")
    paid: Optional[str] = Field(default=None, description="Filtering by paid status. 0 = not paid, 1 = paid, 2 = partially paid")
    billed: Optional[str] = Field(default=None, description="Filtering by billed status. 0 = not billed, 1 = billed")
    sort: Optional[str] = Field(default=None, description="Sort documents. Options: created-asc or created-desc")
