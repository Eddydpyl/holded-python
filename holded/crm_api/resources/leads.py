...
class LeadsResource(BaseResource):
    ...
    def create_note(self, lead_id: str, data: LeadNoteCreate) -> Dict[str, Any]:
        ...
        Returns:
            The created note
        """
        return cast(Dict[str, Any], self.client.post(f"{self.base_path}/{lead_id}/notes", data=data))
    ...
    def update_note(self, lead_id: str, data: LeadNoteUpdate) -> Dict[str, Any]:
        ...
        Returns:
            The updated note
        """
        return cast(Dict[str, Any], self.client.put(f"{self.base_path}/{lead_id}/notes", data=data))
    ...
    def create_task(self, lead_id: str, data: LeadTaskCreate) -> Dict[str, Any]:
        ...
        Returns:
            The created task
        """
        return cast(Dict[str, Any], self.client.post(f"{self.base_path}/{lead_id}/tasks", data=data))
    ...
    def update_task(self, lead_id: str, data: LeadTaskUpdate) -> Dict[str, Any]:
        ...
        Returns:
            The updated task
        """
        return cast(Dict[str, Any], self.client.put(f"{self.base_path}/{lead_id}/tasks", data=data))
    ...
    def update_date(self, lead_id: str, data: LeadDateUpdate) -> Dict[str, Any]:
        ...
        Returns:
            The update response
        """
        return cast(Dict[str, Any], self.client.put(f"{self.base_path}/{lead_id}/dates", data=data))
    ...
    def update_stage(self, lead_id: str, data: LeadStageUpdate) -> Dict[str, Any]:
        ...
        Returns:
            The update response
        """
        return cast(Dict[str, Any], self.client.put(f"{self.base_path}/{lead_id}/stages", data=data))
