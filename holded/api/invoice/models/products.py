...
from ...models import BaseModel, BaseResponse, DateRangeParams, PaginationParams
...
class ProductCreate(BaseModel):
    ...
    stock_management: Optional[StockManagement] = Field(
        default=StockManagement.SIMPLE, description="Stock management type"
    )
...
class ProductCategoryListParams(PaginationParams):
    ...
    include_subcategories: Optional[bool] = Field(
        default=False, description="Whether to include subcategories in the response"
    )
