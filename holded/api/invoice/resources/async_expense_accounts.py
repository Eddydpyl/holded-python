...
class AsyncExpenseAccountsResource:
    ...
    def __init__(self, client):
        ...
        """
        self.client = client
        self.base_path = "invoicing/expensesaccounts"

    async def list(
        self, params: Optional[Union[Dict[str, Any], ExpenseAccountListParams]] = None
    ) -> ExpenseAccountListResponse:
    ...
    async def update(
        self, account_id: str, data: Union[Dict[str, Any], ExpenseAccountUpdate]
    ) -> ExpenseAccountResponse:
